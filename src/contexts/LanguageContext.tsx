...
const translations = {
  zh: {
    ...
    'home.about.desc': '澳洲万年市华人互助会致力于服务年长者，推动邻里互助、社区融合与文化传承。我们通过多元化活动，关爱健康、丰富生活，打造温馨、友爱的社区家园。',
    'home.mission.title': '我们的使命',
    'home.mission.desc': '澳洲万年市华人互助会的使命，是为万年市及周边地区的华人社区提供支持与关怀，促进文化交流、长者福祉、多元文化融合，并通过各种活动增强社区成员之间',
    'home.services.title': '我们的服务',
    'home.services.mutual': '公益互助',
    'home.services.mutual.desc': '倡导邻里守望相助，关爱年长群体，积极参与社区志愿服务',
    'home.services.community': '社区融合',
    'home.services.community.desc': '建设友善包容的社区氛围，鼓励居民之间的沟通交流',
    'home.services.diverse': '多元服务',
    'home.services.diverse.desc': '提供太极、舞蹈、麻将、唱歌、英文、书法、乒乓球等丰富活动',
    'home.services.health': '健康养生',
    'home.services.health.desc': '定期举办健康讲座、健身活动、体检服务，提升长者生活质量',
    'home.services.culture': '文化传承',
    'home.services.culture.desc': '弘扬中华优秀传统文化，促进多元文化的互学互鉴',
    'home.weekly.title': '每周四社区活动',
    'home.weekly.time': '每周四  •  上午10:00 - 下午2:00',
    'home.weekly.location': '地址：293-297 Manningham Rd, Templestowe Lower VIC 3107',
    ...
    'membership.privacy.desc': 'MACMAA尊重并保护您的个人隐私。我们仅会收集用于会员管理、活动通知、紧急联络及社区服务所需的基本信息。我们不会出售、交换、发布或向未经授权的第三方分享您的个人资料。',
    ...
    'admin.events.payment.transfer': '��行转账',
    ...
    'admin.news.form.imageKeywordPlaceholder': '例如: chinese,new,year,celebration',
    'admin.news.form.imageKeywordHelp': '用逗号分隔多个关键词，系统会从Unsplash图库搜索相关图片作为封面',
    ...
    'admin.news.form.unsplashKeywordsPlaceholder': '输入英文关键词，用逗号分隔（如：chinese,new,year,celebration）',
    'admin.news.form.unsplashHelp': '系统将从Unsplash免费图库中搜索匹配的高质量图片',
    ...
    'admin.members.rejectedNote': '提示：已拒绝的会员申请记录将在30天后自动删除',
    ...
    'admin.members.confirm.revoke.message': '确定要取消该会员的会员资格吗？此操作将把会员状态改为已拒绝。',
    'admin.members.confirm.delete.title': '确认删除',
    'admin.members.confirm.delete.message': '确定要删除该会员申请记录吗？此操作无法撤销。',
    'admin.members.confirm.reopen.title': '确认重新审核',
    'admin.members.confirm.reopen.message': '确定要将该会员申请重新标记为待审核状态吗？',
    ...
    'admin.settings.passwordRequirements': '密码要求：至少8个字符，包含大小写字母和数字',
    ...
    'admin.settings.emailNotificationsDesc': '会员申请和活动报名的邮件通知总开关',
    ...
    'admin.accounts.viewOnlyNotice': '您当前为管理员权限，仅可查看账户信息。只有站长可以创建、删除账户。',
    ...
    'admin.accounts.deleteDialog.description': '您确定要删除账户 "{username}" 吗？此操作无法撤销。',
    ...
    'admin.accounts.form.passwordHelp': '密码要求：至少8个字符，包含大小写字母和数字',
    'admin.accounts.form.role': '账户角色',
    'admin.accounts.permissionInfo.title': '权限说明',
    'admin.accounts.permissionInfo.owner1': '站长：拥有所有管理权限，可以创建和删除管理员账户，不可被其他账户删除',
    'admin.accounts.permissionInfo.owner2': '站长：可以管理活动、新闻、会员审核，以及账户管理',
    'admin.accounts.permissionInfo.admin1': '管理员：可以管理活动、新闻、会员审核，但无法访问账户管理',
    'admin.accounts.permissionInfo.admin2': '管理员：只有站长可以创建和删除管理员账户',
  ...
  en: {
    ...
    'home.hero.subtitle': 'Serving seniors, fostering mutual support, community harmony, and cultural heritage',
    'home.hero.cta.news': 'Latest News',
    'home.hero.cta.join': 'Join Us',
    'home.about.title': 'About Us',
    'home.about.desc': 'Manningham Australian Chinese Mutual Aid Association is dedicated to serving seniors, fostering mutual support, community harmony, and cultural heritage. Through diverse activities, we promote health, enrich lives, and build a warm, caring community.',
    'home.mission.title': 'Our Mission',
    'home.mission.desc': 'MACMAA is committed to providing support and care for the Chinese community in Manningham and surrounding areas, promoting cultural exchange, senior wellbeing, multicultural integration, and strengthening connections among community members.',
    'home.services.title': 'Our Services',
    'home.services.mutual': 'Mutual Support',
    'home.services.mutual.desc': 'Promoting neighbourly care, supporting seniors, and encouraging volunteer participation',
    'home.services.community': 'Community Harmony',
    'home.services.community.desc': 'Building a friendly and inclusive community atmosphere through communication',
    'home.services.diverse': 'Diverse Services',
    'home.services.diverse.desc': 'Offering Tai Chi, dance, mahjong, singing, English, calligraphy, table tennis and more',
    'home.services.health': 'Health & Wellbeing',
    'home.services.health.desc': 'Regular health talks, fitness sessions, and medical check-ups for seniors',
    'home.services.culture': 'Cultural Heritage',
    'home.services.culture.desc': 'Promoting traditional Chinese culture and multicultural exchange',
    ...
    'home.activities.desc': 'Capturing the warm moments and wonderful activities of our community',
    ...
    'membership.subtitle': 'Become a MACMAA member and enjoy more community services and event benefits',
    ...
    'membership.form.agree1': 'I confirm that the information provided is true and accurate',
    'membership.form.agree2': 'I agree to abide by the membership guidelines',
    'membership.form.agree3': 'I agree to pay the annual membership fee after approval',
    ...
    'membership.privacy.desc': 'MACMAA respects and protects your personal privacy. We only collect basic information necessary for membership management, event notifications, emergency contact, and community services. We will not sell, exchange, publish or share your personal information with unauthorized third parties.',
    ...
    'admin.events.registrations.search': 'Search Registrations (Name, Phone, Email)...',
    ...
    'admin.news.form.imageKeywordPlaceholder': 'e.g.: chinese,new,year,celebration',
    'admin.news.form.imageKeywordHelp': 'Separate multiple keywords with commas, the system will search for relevant images from the Unsplash library as the cover',
    ...
    'admin.news.form.unsplashKeywordsPlaceholder': 'Enter English keywords, separated by commas (e.g.: chinese,new,year,celebration)',
    'admin.news.form.unsplashHelp': 'The system will search for high-quality images from the Unsplash free library',
    'admin.news.form.uploadImageBtn': 'Select and Upload Image',
    'admin.news.form.uploadHelp': 'Supports JPG, PNG, GIF, etc. formats, can be cropped and adjusted after upload',
    ...
    'admin.news.deleteConfirm': 'Are you sure you want to delete this news item?',
    ...
    'admin.members.rejectedNote': 'Note: Rejected member application records will be automatically deleted after 30 days',
    'admin.members.confirm.approve.title': 'Confirm Approval',
    'admin.members.confirm.approve.message': 'Are you sure you want to approve this member application?',
    'admin.members.confirm.reject.title': 'Confirm Rejection',
    'admin.members.confirm.reject.message': 'Are you sure you want to reject this member application?',
    'admin.members.confirm.revoke.title': 'Confirm Revocation',
    'admin.members.confirm.revoke.message': 'Are you sure you want to revoke this member\'s membership? This action will change the member status to rejected.',
    'admin.members.confirm.delete.title': 'Confirm Deletion',
    'admin.members.confirm.delete.message': 'Are you sure you want to delete this member application record? This action cannot be undone.',
    'admin.members.confirm.reopen.title': 'Confirm Reopen',
    'admin.members.confirm.reopen.message': 'Are you sure you want to reopen this member application for review?',
    ...
    'admin.settings.emailDesc': 'Used for receiving notifications and password recovery',
    ...
    'admin.settings.passwordRequirements': 'Password Requirements: At least 8 characters, including uppercase and lowercase letters and numbers',
    ...
    'admin.settings.passwordMismatch': 'New password and confirm password do not match',
    ...
    'admin.settings.emailNotificationsDesc': 'Master switch for member applications and event registrations email notifications',
    'admin.settings.memberNotifications': 'Member Application Notifications',
    'admin.settings.memberNotificationsDesc': 'Send email notifications when a new member application is received',
    'admin.settings.eventNotifications': 'Event Registration Notifications',
    'admin.settings.eventNotificationsDesc': 'Send email notifications when there is a new event registration',
    ...
    'admin.settings.emailLanguageDesc': 'Choose the language for email notifications',
    ...
    'admin.accounts.viewOnlyNotice': 'You currently have admin permissions, only able to view account information. Only owners can create and delete accounts.',
    ...
    'admin.accounts.deleteDialog.description': 'Are you sure you want to delete the account "{username}"? This action cannot be undone.',
    'admin.accounts.deleteDialog.confirm': 'Delete Account',
    'admin.accounts.createDialog.title': 'Create New Account',
    'admin.accounts.createDialog.description': 'Fill in the following information to create a new admin account',
    ...
    'admin.accounts.form.passwordHelp': 'Password Requirements: At least 8 characters, including uppercase and lowercase letters and numbers',
    'admin.accounts.form.role': 'Account Role',
    'admin.accounts.permissionInfo.title': 'Permission Information',
    'admin.accounts.permissionInfo.owner1': 'Owner: Has all management permissions, can create and delete admin accounts, cannot be deleted by other accounts',
    'admin.accounts.permissionInfo.owner2': 'Owner: Can manage events, news, member reviews, and account management',
    'admin.accounts.permissionInfo.admin1': 'Admin: Can manage events, news, member reviews, but cannot access account management',
    'admin.accounts.permissionInfo.admin2': 'Admin: Only owners can create and delete admin accounts',
    ...
    'footer.rights': '© 2025 Manningham Australian Chinese Mutual Aid Association. All rights reserved.',
  },
};
