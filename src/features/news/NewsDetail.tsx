  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      >
        ...
        {/* Related News or CTA */}
        <div className="mt-12 py-5 px-6 bg-[#F5EFE6] rounded-xl flex items-center justify-center gap-4 flex-wrap">
          ...
          <Link href="/events">
            <motion.button
              className="px-6 py-2 bg-[#2B5F9E] text-white rounded-lg hover:bg-[#234a7e] transition-colors text-sm"
