      ...
      >
        ...
        >
          ...
          <div className="mt-6 p-4 bg-[#F5EFE6] rounded-lg text-sm text-gray-700">
            <p className="mb-3">
              <strong>{language === 'zh' ? '测试账户：' : 'Test Accounts:'}</strong>
            </p>
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="ml-4 text-xs">
                  {t('admin.login.username')}: <strong>zhang_admin</strong> {language === 'zh' ? '或' : 'or'} <strong>admin</strong>
                </p>
                <p className="ml-4 text-xs">
                  {t('admin.login.password')}: <strong>Admin@123</strong> {language === 'zh' ? '或' : 'or'} <strong>demo123</strong>
                </p>
              </div>
            </div>
          </div>
