...
export function Membership() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    createMemberApplication({
      ...
      .catch(() => {
        setSubmitError(language === 'zh' ? '提交失败，请稍后再试。' : 'Submission failed, please try again later.');
      })
        ...
        {!submitted ? (
          ...
          >
            ...
            <div className="text-center mb-8 sm:mb-12">
              ...
              <h1 className="text-[#2B5F9E] mb-3 sm:mb-4 text-3xl sm:text-4xl px-2">{t('membership.title')}</h1>
              <p className="text-gray-700 max-w-2xl mx-auto mb-2 text-sm sm:text-base px-4">
                {t('membership.subtitle')}
              </p>
              <div className="text-[#2B5F9E] px-4">
                <p className="mb-1 text-base sm:text-lg">{t('membership.fee')}</p>
                <p className="text-xs sm:text-sm text-gray-600">{t('membership.feeNote')}</p>
              </div>
            </div>
            ...
            >
              <h3 className="mb-2 text-xl sm:text-2xl">{t('home.weekly.title')}</h3>
              <p className="mb-1 text-sm sm:text-base">{t('home.weekly.time')}</p>
            ...
            >
              <h2 className="text-[#2B5F9E] mb-5 sm:mb-6 text-2xl sm:text-3xl">{t('membership.form.title')}</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    ...
                    <input
                      ...
                      placeholder={language === 'zh' ? '例如：张三' : 'e.g., 张三'}
                    />
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={language === 'zh' ? '例如：123 Main St, Melbourne VIC 3000' : 'e.g., 123 Main St, Melbourne VIC 3000'}
                  />
                ...
                <div className="border-t pt-6">
                  <h3 className="text-[#2B5F9E] mb-4">{t('membership.form.emergency')}</h3>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder={language === 'zh' ? '例如：张三' : 'e.g., John Smith'}
                      />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      <div>
                        ...
                        {touched.emergencyPhone && errors.emergencyPhone && (
                          ...
                          >
                            <AlertCircle className="w-4 h-4" />
                            <span>{getErrorMessage(errors.emergencyPhone)}</span>
                          </motion.div>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          placeholder={language === 'zh' ? '例如：配偶、子女' : 'e.g., Spouse, Child'}
                        />
                        {touched.emergencyRelation && errors.emergencyRelation && (
                          ...
                          >
                            <AlertCircle className="w-4 h-4" />
                            <span>{getErrorMessage(errors.emergencyRelation)}</span>
                          </motion.div>
                        )}
                      </div>
                    </div>
                ...
                <div className="bg-[#F5EFE6] rounded-lg p-4">
                  ...
                  <p className="text-[#2B5F9E]">{t('membership.form.regular')}</p>
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                >
                  {submitting ? (language === 'zh' ? '提交中...' : 'Submitting...') : t('membership.form.submit')}
                </motion.button>
              ...
              <div className="mt-8 p-4 bg-[#F5EFE6] rounded-lg">
                <h4 className="text-[#2B5F9E] mb-2">{t('membership.privacy.title')}</h4>
                <p className="text-sm text-gray-700">{t('membership.privacy.desc')}</p>
              </div>
          ...
          >
            ...
            <div className="bg-[#F5EFE6] rounded-xl p-6 mb-8 max-w-md mx-auto">
              ...
              <div className="text-left space-y-2 text-gray-700">
                <p><strong>{t('membership.form.chineseName')}:</strong> {formData.chineseName}</p>
                <p><strong>{t('membership.form.englishName')}:</strong> {formData.englishName}</p>
