              ...
              {FILTER_OPTIONS.map((status) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-lg transition-colors ${
                    filterStatus === status ? "bg-[#2B5F9E] text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                  }`}
                >
              ...
              >
                <div className="sticky top-0 bg-gradient-to-r from-[#2B5F9E] to-[#6BA868] text-white p-6 rounded-t-2xl flex-shrink-0">
                  <div className="flex items-center justify-between">
                    ...
                    <button onClick={() => setSelectedMember(null)} className="p-2 hover:bg-white/20 rounded-lg transition-colors">
                      <X className="w-6 h-6" />
                    </button>
                  </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-4">
                  <div className="flex flex-wrap items-center gap-3 mb-4">
                    ...
                    {selectedMember.status === "pending" && (
                      <div className="flex gap-2">
                        <button
                          onClick={() => openConfirmDialog("approve", selectedMember)}
                        ...
                        <button
                          onClick={() => openConfirmDialog("reject", selectedMember)}
                    ...
                    {selectedMember.status === "approved" && (
                      <button
                        onClick={() => openConfirmDialog("revoke", selectedMember)}
                    ...
                    {selectedMember.status === "rejected" && (
                      <div className="flex gap-2">
                        <button
                          onClick={() => openConfirmDialog("reopen", selectedMember)}
                        ...
                        <button
                          onClick={() => openConfirmDialog("delete", selectedMember)}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <InfoField label={t("admin.members.detail.chineseName")} value={selectedMember.chinese_name} />
                    <InfoField label={t("admin.members.detail.englishName")} value={selectedMember.english_name} />
                    <InfoField
                  ...
                  <div className="border-t pt-4 mt-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <InfoField label={t("admin.members.detail.emergency")} value={selectedMember.emergency_name ?? ""} />
                      <InfoField
                      ...
                      />
                      <InfoField label={t("admin.members.table.applyDate")} value={selectedMember.apply_date ?? ""} />
                    </div>
                  </div>
                </div>
